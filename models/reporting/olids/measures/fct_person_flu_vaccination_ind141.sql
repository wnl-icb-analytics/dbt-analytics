...
-- Flu vaccination in the most recently completed season (1 August to 31 March) for people on the COPD register; excludes a contraindication recorded in 12 months.
WITH register AS (
...
SELECT
    person_id,
    'IND141' AS indicator_id,
    'Immunisation: flu vaccine for people with COPD' AS indicator_name,
