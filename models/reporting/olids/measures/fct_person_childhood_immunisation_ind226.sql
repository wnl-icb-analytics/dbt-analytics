...
WITH indicator_population AS (
    ...
    WHERE DATEADD(month, 18, profile.birth_date_approx) > DATEADD(month, -12, CURRENT_DATE())
        AND DATEADD(month, 18, profile.birth_date_approx) <= CURRENT_DATE()
...
assessed AS (
    SELECT
        ...
        population.primary_doses_by_12_months,
        population.booster_doses_12_to_18_months,
        population.primary_doses_by_12_months >= 2
            AND population.booster_doses_12_to_18_months >= 1 AS is_in_numerator
