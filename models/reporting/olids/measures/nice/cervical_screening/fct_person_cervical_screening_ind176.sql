...
-- Cervical screening recorded in 3.5 years for women aged 25 to 49; excludes unsuitable (no cervix), non-response to invitations in 12 months and pregnancy.
...
assessed AS (
    SELECT
        ...
        CASE WHEN population.latest_completed_date >= DATEADD(month, -42, CURRENT_DATE())
