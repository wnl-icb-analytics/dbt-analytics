...
assessed AS (
    SELECT
        ...
        CASE WHEN population.has_egfr_within_90_days_of_diagnosis AND population.has_acr_within_90_days_of_diagnosis THEN population.ckd_diagnosis_date END AS latest_record_date,
