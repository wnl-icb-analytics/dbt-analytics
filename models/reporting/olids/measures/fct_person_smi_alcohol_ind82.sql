...
assessed AS (
    SELECT
        ...
        CASE WHEN population.latest_alcohol_record_date >= DATEADD(month, -15, CURRENT_DATE()) THEN population.latest_alcohol_record_date END AS latest_record_date,
        COALESCE(population.latest_alcohol_record_date >= DATEADD(month, -15, CURRENT_DATE()), FALSE) AS is_in_numerator
