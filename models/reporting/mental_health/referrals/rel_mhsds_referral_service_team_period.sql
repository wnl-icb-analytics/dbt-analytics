with primary_teams as (
    select
        ...
        ]) }} as referral_service_team_period_id
        , r.uniq_serv_req_id
...
select
    r.referral_service_team_period_id
...
qualify row_number() over (
    partition by r.referral_service_team_period_id
    order by r.source_file_received_at desc nulls last, r.source_record_id desc
) = 1
