...
/*
Cardiovascular risk assessment records from the PCD clusters CVDRISKASS_COD,
CVDASS2_COD and QRISKSCORE_COD, one row per observation: QRISK, QRISK2, QRISK3, JBS and
...
SELECT
    ...
    obs.cluster_id = 'CVDASS2_COD' AS is_cvd_risk_score_code,
    obs.cluster_id = 'QRISKSCORE_COD' OR obs.mapped_concept_display ILIKE '%QRISK%' AS is_qrisk_code
FROM ({{ get_observations("'CVDRISKASS_COD', 'CVDASS2_COD', 'QRISKSCORE_COD'", source='PCD') }}) obs
