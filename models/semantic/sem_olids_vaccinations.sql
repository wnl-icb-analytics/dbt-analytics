...
DIMENSIONS(
    ...
    demographics.age_band_5y AS age_band_5y COMMENT = '5-year age bands from current age, not age at the campaign',
    demographics.age_band_10y AS age_band_10y COMMENT = '10-year age bands from current age, not age at the campaign',
    demographics.age_band_nhs AS age_band_nhs COMMENT = 'NHS Digital standard age bands from current age, not age at the campaign reference date: 0-4, 5-14, 15-24, 25-34, 35-44, 45-54, 55-64, 65-74, 75-84, 85+',
